...
class DndProficiencyGroup(availableOptions: List<DndProficiency>, private val selectedOptions: MutableList<DndProficiency>, private val totalChoiceCount: Int) {
