...
class SimpleExaminer(val requirement: Requirement<Any>, private val halts: Boolean = false): Examiner<Any> {

	override fun examine(state: Any): Examination<Any> {
		return StaticExamination(listOf(SimpleFulfillment(requirement)), halts)
	}
